...
Player_Wins_San_Juan = {
    html: '<div id="Player_Wins_San_Juan">\<p class="text_border">As he opens the back and pulls out the memory card, your loved one comes running from around a corner, into your arms. <br> "You have found me! Lets get out of here.</p></div>'};
...
Player_Loses_San_Juan={
   html:'<div id="Player_Loses_San_Juan"><p class="text_border">Suddenly, a blow to the opposite side of the plane sends you flying into the seat in front of you. You heart sinks to your knees and you become frozen in your seat as the pilots trembling voice says "We have been hit by a drone".</p></div>'};
